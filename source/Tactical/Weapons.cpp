...
UINT16 GunRange( OBJECTTYPE * pObj, SOLDIERTYPE * pSoldier ) // SANDRO - added argument
{
	...
	if ( Item[ pObj->usItem ].usItemClass & IC_WEAPON )
	{
		...
		rng = ( Weapon[ pObj->usItem ].usRange * GetRangeBonusIoV(pObj) ) / 10000; //kenkenkenken: IoV921+z.3 rng¸ÄÎª°´±ÈÀýÔö¼ÓÉä³Ì¹«Ê½
...
//kenkenkenken: IoV921+z.5 ²å°å·Àµ¯ -->
...
INT32 ArmourPercent( SOLDIERTYPE * pSoldier )
{
	...
	//kenkenkenken: IoV921+z.5 Ôö¼Ó²å°å·Àµ¯Ð§¹û -->
	INT32 iVestPack;
...
INT8 ArmourVersusExplosivesPercent( SOLDIERTYPE * pSoldier )
{
	...
	//kenkenkenken: IoV921+z.5 ²å°å·Àµ¯Ð§¹û -->
	INT32 iVestPack;
	if (pSoldier->inv[VESTPOCKPOS].exists() == true)
	{
...
//kenkenkenken: IoV921+z.5 Add CheckForGunJam Function --> IoV×Ô¶¨Òå¹ÊÕÏÂÊº¯Êý
...
BOOLEAN	OKFireWeapon( SOLDIERTYPE *pSoldier )
{
	...
	bGunJamVal = CheckForGunJamIoV( pSoldier ); //kenkenkenken: IoV921+z.5 µ÷ÓÃIoV×Ô¶¨Òå¹ÊÕÏÂÊº¯Êý
